...
# Now rbind should work (all have same number of columns)
...
# Step 3: Extract just the scores for clustering
anomaly_scores <- all_anomalies[, -(1:2)]  # Remove Day and Location

# Step 4: Find optimal K using silhouette method
silhouette_scores <- data.frame(K = integer(), Silhouette = double())
...
# Step 5: Run final k-means with best K
