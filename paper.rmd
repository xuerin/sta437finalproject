...
print(pca_summary)
```
```{r pca-boxplots-specific, fig.height=3, echo=FALSE, message=FALSE, warning=FALSE}
...
```{r fa-boxplots-specific, fig.height=3, echo=FALSE, message=FALSE, warning=FALSE}
...
print(ica_summary)
```
```{r ica-boxplots, fig.height=3, echo=FALSE, message=FALSE, warning=FALSE}
...
```{r cluster-global-anomalies, fig.height = 4, echo=FALSE, message=FALSE, warning=FALSE}
