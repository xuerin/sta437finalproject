...
```{r plot-pca-loading, echo=FALSE, message=FALSE, warning=FALSE, fig.cap="PCA Loadings for 2 Anomalies", fig.pos='H'}
...
print(pca_summary)
```
```{r pca-boxplots-specific, fig.height=3, echo=FALSE, message=FALSE, warning=FALSE, fig.cap="Boxplot for 1 PCA Anomaly", fig.pos='H'}
...
```{r fa-loadings, echo=FALSE, message=FALSE, warning=FALSE, fig.cap="FA Loadings for 2 Anomalies"}
...
print(fa_summary)
```
```{r fa-boxplots-specific, fig.height=3, echo=FALSE, message=FALSE, warning=FALSE, fig.cap="Boxplot for 1 FA Anomaly", fig.pos='H'}
...
```{r ica-loadings-specific, echo=FALSE, message=FALSE, warning=FALSE, fig.cap="ICA Loadings for 2 Anomalies"}
...
print(ica_summary)
```
```{r ica-boxplots, fig.height=3, echo=FALSE, message=FALSE, warning=FALSE, fig.cap="Boxplot for 1 ICA Anomaly",  fig.pos='H'}
